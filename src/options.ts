...
export interface BaseCapacitorOptions {
  ...
  /**
   * When enabled, Sentry will capture failed XHR/Fetch requests. This option also enables HTTP Errors on iOS.
   *
   * @default false
   */
   ...
   * at the root of Capacitor Options at the cost of loss of JSDocs visibility.
   */
  siblingOptions?: {
    /**
  ...
  _experiments?: {
     ...
     * @default false
     * @experimental
     * @platforms web and iOS only. In the future it will be enabled on Android.
     */
